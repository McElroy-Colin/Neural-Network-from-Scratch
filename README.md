...
Check for progress in the `dev` branch!
...
- Understanding the inner workings of layers, weights, activations, and backpropagation.
- Providing a minimal, flexible framework to experiment with **small datasets and basic network architectures**.
...
- Dynamic allocation of layers and neurons.
